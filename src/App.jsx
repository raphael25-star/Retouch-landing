...
function DashboardPage({ user, navigate, onLogout, refreshUser, sessionChecked }) {
  ...
  const tools = [
    // ─── TEMPLATES TENDANCES (en premier) ───
    {
      ...
      userPromptDefault: "",
expertPromptPrefix: "Keep the original image exactly the same. Add the watch onto the wrist. Match ONLY: lighting of the photo, color temperature, shadows. The watch must follow the wrist angle and wrap naturally around it. Add natural contact shadows where the watch touches the skin. The watch must not be too sharp, it should match the photo quality. No perfect render. No studio look. User additional instructions: ",      cover: IMG.serpentPrank,
      model: "google/nano-banana-edit",
      type: "edit",
      premium: false,
      trending: true,
