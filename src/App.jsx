...
{ name: "Amélioration HD", icon: <ZapIcon />, model: "google/nano-banana-edit", promptTemplate: "Transform this image into a hyper-detailed realistic photograph. Enhance all details with extreme realism: skin pores, texture, wrinkles, imperfections, hair strands, baby hairs, fabric threads, bone and muscle structure. Natural light direction revealing texture. Neutral color science, realistic contrast, no artificial smoothing or beauty correction. Micro-contrast, slight natural grain, organic sharpness. The result must look like a real high-resolution smartphone photo, not AI-generated, not polished. Keep the exact same subject, pose, expression, angle, clothing and background.", type: "edit", premium: false },
