...
function DashboardPage({ user, navigate, onLogout, refreshUser, sessionChecked }) {
  ...
  const tools = [
    ...
    },
    {
      ...
      expertPromptPrefix: "Combine the two provided images into one composition. Place the snake from the second image into the scene from the first image, near furniture or in a corner of the room. Add a soft shadow beneath the snake on the floor. Match the lighting direction, color temperature, and warmth of the first image. The snake should be proportionally sized for the room. Photorealistic smartphone photo with natural film grain. User additional instructions: ",
      promptTemplate: "",
    ...
    },
    {
      ...
      expertPromptPrefix: "Combine the two provided images into one composition. Place the person from the second image standing in the room from the first image. Add a soft shadow beneath their feet on the floor. Match the lighting direction, color temperature, and warmth of the room. The person should be proportionally sized for the room. Photorealistic smartphone photo with natural film grain. User additional instructions: ",
      promptTemplate: "",
      randomSources: [
