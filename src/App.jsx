...
expertPromptPrefix: "Keep the original image exactly as it is. Do not recreate the scene. Your task is ONLY to integrate the watch onto the wrist in a physically realistic way. The watch must behave like a real object worn on the wrist: it must follow the exact curvature of the wrist (slight bending and perspective distortion), the bracelet must wrap tightly around the arm with natural compression on the skin, add subtle skin deformation where the bracelet touches the wrist. Lighting: match the exact lighting of the photo (soft indoor daylight), add realistic shadows under the watch and between each bracelet link, add slight occlusion shadows where the watch touches the skin. Camera consistency: match the exact blur, noise, and compression of the original iPhone photo, slightly reduce sharpness of the watch so it matches the image quality, add micro imperfections (tiny blur, grain, slight softness). Reflections: reflections must match the real environment (kitchen, wood, ambient light), avoid perfect or studio-like reflections. Avoid: ultra sharp watch, perfect edges, product render look, floating effect, unrealistic symmetry. The watch must feel slightly imperfect, like a real photo. Final result must be indistinguishable from a real casual smartphone photo. User additional instructions: ",      subtitle: "Faites peur à vos proches en 1 clic",
      icon: <Sparkle s={18} />,
