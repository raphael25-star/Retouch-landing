...
function DashboardPage({ user, navigate, onLogout, refreshUser, sessionChecked }) {
  ...
  const tools = [
    ...
    },
    {
      ...
      expertPromptPrefix: "Realistically integrate the snake from the second image into the scene from the first image as if it was naturally present in the environment. CRITICAL: Add a dark, well-defined contact shadow directly beneath the snake's body where it touches the ground or surface. The shadow must be soft but clearly visible, indicating physical presence. Without this shadow the snake will look fake. Match the lighting direction, color temperature, and shadows of the original scene exactly. Adapt the snake's scale and position naturally in the space (peeking out from a closet, sliding under a bed, coiled on the floor, etc.). Preserve the snake's anatomy, scales, color, and details exactly as shown in the source image. Apply realistic photographic style: subtle motion blur, slight compression artifacts, natural smartphone camera grain, slightly imperfect framing - as if quickly captured in panic. The result must look like a genuine smartphone photo taken in haste, NOT a clean composite. Imperfections are essential for realism. User additional instructions: ",
      promptTemplate: "",
    ...
    },
    {
      ...
      expertPromptPrefix: "Realistically integrate the plumber from the second image into the scene from the first image as if he was naturally present in the room. CRITICAL: Add dark, well-defined contact shadows beneath his feet and where his body touches surfaces. The shadows must be soft but clearly visible, anchoring him to the ground. Without these shadows the plumber will look pasted-on. Match the lighting direction, color temperature, and overall ambient color of the original room exactly. Adapt his pose, angle, and scale naturally in the space - he should appear to be standing, working, or moving through the room as if he had been doing this for a while. Preserve the plumber's facial features, body type, clothing, tools, and expression exactly as shown in the source image. Apply realistic photographic style: subtle motion blur, slight compression artifacts, natural smartphone camera grain, slightly imperfect framing - as if the photo was secretly snapped from a doorway. The result must look like a genuine smartphone photo, NOT a clean composite. Imperfections are essential for realism. User additional instructions: ",
      promptTemplate: "",
      randomSources: [
